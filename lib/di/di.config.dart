...
import '../features/authentication/user_session.dart' as _i9;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i9.UserSession>(_i9.UserSession(get<_i4.FirebaseAuth>(),
      get<_i8.IUserRepository>(), get<_i6.GoogleProvider>()));
  gh.singleton<_i10.ICustomerService>(_i10.CustomerService(
      get<_i5.FirebaseFirestore>(), get<_i9.UserSession>()));
  gh.singleton<_i11.ISettingService>(_i11.SettingService(
      get<_i9.UserSession>(), get<_i5.FirebaseFirestore>()));
  gh.factory<_i12.SignInBloc>(() =>
      _i12.SignInBloc(get<_i8.IUserRepository>(), get<_i9.UserSession>()));
  gh.factory<_i13.SplashBloc>(() => _i13.SplashBloc(get<_i9.UserSession>()));
  gh.singleton<_i14.ICustomerRepository>(
      _i14.CustomerRepository(get<_i10.ICustomerService>()));
  gh.singleton<_i15.ISettingRepository>(
      _i15.SettingRepository(get<_i11.ISettingService>()));
  gh.factory<_i16.SettingViewBloc>(() => _i16.SettingViewBloc(
      get<_i15.ISettingRepository>(), get<_i9.UserSession>()));
  ...
  gh.factory<_i21.HomeViewBloc>(
      () => _i21.HomeViewBloc(get<_i14.ICustomerRepository>()));
  return get;
}
