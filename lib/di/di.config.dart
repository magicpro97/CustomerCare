...
import '../features/authentication/user_session.dart' as _i19;
...
import '../pages/customer/add_customer/add_customer_bloc.dart' as _i20;
import '../pages/customer/customer_factory.dart' as _i5;
import '../pages/customer/edit_customer/edit_customer_bloc.dart' as _i22;
import '../pages/customer/upload_id_card/upload_id_card_bloc.dart' as _i18;
import '../pages/home/customer/customer_view_bloc.dart' as _i21;
import '../pages/home/home/customer_contact_factory.dart' as _i4;
import '../pages/home/home/home_view_bloc.dart' as _i24;
import '../pages/home/home_page_bloc.dart' as _i23;
import '../pages/home/setting/setting_view_bloc.dart' as _i25;
import '../pages/sign_in/sign_in_bloc.dart' as _i26;
import '../pages/splash/splash_bloc.dart' as _i27;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i18.UploadIdCardBloc>(
      () => _i18.UploadIdCardBloc(get<_i15.ICustomerRepository>()));
  gh.singleton<_i19.UserSession>(_i19.UserSession(
      get<_i6.FirebaseAuth>(),
      get<_i17.IUserRepository>(),
      get<_i9.GoogleProvider>(),
      get<_i13.SharedPreferences>()));
  gh.factory<_i20.AddCustomerBloc>(() => _i20.AddCustomerBloc(
      get<_i15.ICustomerRepository>(), get<_i5.CustomerFactory>()));
  gh.factory<_i21.CustomerViewBloc>(() => _i21.CustomerViewBloc(
      get<_i15.ICustomerRepository>(),
      get<_i14.CacheNotification>(),
      get<_i5.CustomerFactory>()));
  gh.factory<_i22.EditCustomerBloc>(() => _i22.EditCustomerBloc(
      get<_i15.ICustomerRepository>(), get<_i5.CustomerFactory>()));
  gh.factory<_i23.HomePageBloc>(
      () => _i23.HomePageBloc(get<_i15.ICustomerRepository>()));
  gh.factory<_i24.HomeViewBloc>(() => _i24.HomeViewBloc(
      get<_i15.ICustomerRepository>(), get<_i4.CustomerContactFactory>()));
  gh.factory<_i25.SettingViewBloc>(() => _i25.SettingViewBloc(
      get<_i16.ISettingRepository>(), get<_i19.UserSession>()));
  gh.factory<_i26.SignInBloc>(() =>
      _i26.SignInBloc(get<_i17.IUserRepository>(), get<_i19.UserSession>()));
  gh.factory<_i27.SplashBloc>(() => _i27.SplashBloc(get<_i19.UserSession>()));
  return get;
}
